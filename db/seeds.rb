...
user = User.find(1)
user.dishes.create(:name => 'Curly fry sandwich', :description => 'No drink included!', :direct_image_url => 'https://scontent.cdninstagram.com/hphotos-xpa1/t51.2885-15/e15/11049217_1050798778268911_1794059291_n.jpg', :price => 16.0, active: true)
user.dishes.create(:name => 'Sandwich special', :description => 'This has fries which you can eat with ketchup', :direct_image_url => 'https://scontent.cdninstagram.com/hphotos-xpa1/t51.2885-15/e15/11190839_805640789526181_646591393_n.jpg', :price => 20.0, active: true)
user.dishes.create(:name => 'Fresh Soylent', :description => 'Soylent is a new form of food replacement', :direct_image_url => 'https://scontent.cdninstagram.com/hphotos-xat1/t51.2885-15/e15/11093130_1004141852944320_1506520240_n.jpg', :price => 15.0, active: true)
user.dishes.create(:name => 'Breakfast Special', :description => 'bagel + coffee', :direct_image_url => 'https://scontent.cdninstagram.com/hphotos-xap1/t51.2885-15/e15/11176423_790570584373337_2062673856_n.jpg', :price => 5.0, active: true)
user.dishes.create(:name => 'Steak', :description => 'Delicious steak', :direct_image_url => 'https://scontent.cdninstagram.com/hphotos-xat1/t51.2885-15/e15/11186826_1583942281846613_998802125_n.jpg', :price => 100.0, active: true)
...
user = User.find(2)
user.dishes.create(:name => 'Leaf', :description => 'A good leaf', :direct_image_url => "https://scontent.cdninstagram.com/hphotos-xaf1/t51.2885-15/e15/11236108_830332670386695_1290447161_n.jpg", :price => 1000, active: true)

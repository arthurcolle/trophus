        ...
        success: function(user_json) {
          ...
          infoWindowContent.push(
            ['<div class="info_content">'+
                '<h5>'+
                  uj["name"]+
                '</h5>'+'<a href ="users/'+num+'/show"'+'><img src="'+uj["prof_pic"]+'" style="border-radius: 20px 20px 20px 20px" height="150px"></a>'+
                '<p>'+
                  uj["home"]+
                '</p>'+
...
(function() {
  this.addStripeInformation = function(data) {
    var handler;
  ...
  $(function() {
    return $('#addcard').addEventListener("click", function() {
      return this.addStripeInformation;
    });
  });

  jQuery(function() {
    return $('.tabs_image').click(function() {});
  });
